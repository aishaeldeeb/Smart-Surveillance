...
parser.add_argument('--dataset', default='home_survillance', help='dataset to train on')
parser.add_argument('--plot-freq', type=int, default=10, help='frequency of plotting')
parser.add_argument('--max-epoch', type=int, default=2000, help='maximum iteration to train')
