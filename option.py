...
parser.add_argument('--train-list', default='list/train_list_v2.list', help='train rgb features list')
parser.add_argument('--val-list', default='list/test_list_v2.list', help='validation rgb features list')
parser.add_argument('--test-list', default='list/test_list_v2.list', help='test rgb features list')

# parser.add_argument('--gt', default='list/gt.npy', help='file of ground truth ')
parser.add_argument('--val_gt', default='list/gt_v2.npy', help='file of ground truth ')
parser.add_argument('--test_gt', default='list/gt_v2.npy', help='file of ground truth ')
